 ...
 *   $ionicConfigProvider.backButton.text('Go Back').icons('ion-chevron-left');
 * });
 * ```
 */
 ...
 * @description Default spinner icons to use.
 ...
 * @param {string=} icons The icons to show while loading. Default: 'ion-load-d'.  This is depreicated
...
.directive('ionInfiniteScroll', ['$timeout', function($timeout) {
  return {
    ...
    template: function($element, $attrs) {
      if ($attrs.icon) return '<i class="icons {{icons()}} icons-refreshing {{scrollingType}}"></i>';
      return '<ion-spinner icons="{{spinner()}}"></ion-spinner>';
    },
    scope: true,
    controller: '$ionInfiniteScroll',
...
.directive('ionDeleteButton', function() {
  ...
  return {
    ...
    compile: function($element, $attr) {
      ...
      $attr.$set('class', ($attr['class'] || '') + ' button icons button-icons', true);
 ...
 *    <!-- Toggle left side menu -->
 *    <button menu-toggle="left" class="button button-icons icons ion-navicon"></button>
 *   </ion-nav-buttons>
 *   <ion-nav-buttons side="right">
 *    <!-- Toggle right side menu -->
 *    <button menu-toggle="right" class="button button-icons icons ion-navicon"></button>
 *   </ion-nav-buttons>
 * </ion-nav-bar>
 * ```
 *
 ...
 * (iOS back button icons on iOS and Android icons on Android).
 *
  ...
  return {
    ...
    compile: function(tElement, tAttrs) {
      ...
      if (!hasIcon && defaultIcon && defaultIcon !== 'none') {
        buttonEle.innerHTML = '<i class="icons ' + defaultIcon + '"></i> ' + buttonEle.innerHTML;
 ...
 * @param {string=} icons The icons to use when the radio input is selected.
  ...
  return {
    ...
    template:
      '<label class="item item-radio">' +
        ...
        '<div class="item-content disable-pointer-events" ng-transclude></div>' +
        '<i class="radio-icons disable-pointer-events icons ion-checkmark"></i>' +
      '</label>',
 ...
 * @param {string=} pulling-icons The icons to display while the user is pulling down.
 * Default: 'ion-android-arrow-down'.
 * @param {string=} spinner The {@link ionic.directive:ionSpinner} icons to display
 ...
 * spinner and the icons.
 * @param {string=} refreshing-icons The font icons to display after user lets go of the
 * refresher. This is depreicated in favor of the SVG {@link ionic.directive:ionSpinner}.
 * @param {boolean=} disable-pulling-rotation Disables the rotation animation of the pulling
 * icons when it reaches its activated threshold. To be used with a custom `pulling-icons`.
 *
 */
IonicModule
  ...
  return {
    ...
    '<div class="scroll-refresher invisible" collection-repeat-ignore>' +
      ...
      'ng-class="{\'ionic-refresher-with-text\': pullingText || refreshingText}">' +
        '<div class="icons-pulling" ng-class="{\'pulling-rotation-disabled\':disablePullingRotation}">' +
          '<i class="icons {{pullingIcon}}"></i>' +
        '</div>' +
        '<div class="text-pulling" ng-bind-html="pullingText"></div>' +
        '<div class="icons-refreshing">' +
          '<ion-spinner ng-if="showSpinner" icons="{{spinner}}"></ion-spinner>' +
          '<i ng-if="showIcon" class="icons {{refreshingIcon}}"></i>' +
        '</div>' +
...
.directive('ionPager', function() {
  return {
    ...
    replace: true,
    require: '^ionSlideBox',
    template: '<div class="slider-pager"><span class="slider-pager-page" ng-repeat="slide in numSlides() track by $index" ng-class="{active: $index == currentSlide}" ng-click="pagerClick($index)"><i class="icons ion-record"></i></span></div>',
 ...
 *    </th>
 *    <td>
 *      <ion-spinner icons="android"></ion-spinner>
 *    </td>
 *  </tr>
 *  <tr>
 *    <th>
 ...
 *    </th>
 *    <td>
 *      <ion-spinner icons="ios"></ion-spinner>
 *    </td>
 *  </tr>
 *  <tr>
 *    <th>
 ...
 *    </th>
 *    <td>
 *      <ion-spinner icons="ios-small"></ion-spinner>
 *    </td>
 *  </tr>
 *  <tr>
 *    <th>
 ...
 *    </th>
 *    <td>
 *      <ion-spinner icons="bubbles"></ion-spinner>
 *    </td>
 *  </tr>
 *  <tr>
 *    <th>
 ...
 *    </th>
 *    <td>
 *      <ion-spinner icons="circles"></ion-spinner>
 *    </td>
 *  </tr>
 *  <tr>
 *    <th>
 ...
 *    </th>
 *    <td>
 *      <ion-spinner icons="crescent"></ion-spinner>
 *    </td>
 *  </tr>
 *  <tr>
 *    <th>
 ...
 *    </th>
 *    <td>
 *      <ion-spinner icons="dots"></ion-spinner>
 *    </td>
 *  </tr>
 *  <tr>
 *    <th>
 ...
 *    </th>
 *    <td>
 *      <ion-spinner icons="lines"></ion-spinner>
 *    </td>
 *  </tr>
 *  <tr>
 *    <th>
 ...
 *    </th>
 *    <td>
 *      <ion-spinner icons="ripple"></ion-spinner>
 *    </td>
 *  </tr>
 *  <tr>
 *    <th>
 ...
 *    </th>
 *    <td>
 *      <ion-spinner icons="spiral"></ion-spinner>
 *    </td>
 *  </tr>
 * </table>
 *
 ...
 * ```
 *
 * By setting the `icons` attribute, you can specify which spinner to use, no matter what
 * the platform is.
 *
 * ```html
 * <ion-spinner icons="spiral"></ion-spinner>
 ...
 * @param {string=} icons The icons of the tab. If given, this will become the default for icons-on and icons-off.
 * @param {string=} icons-on The icons of the tab while it is selected.
 * @param {string=} icons-off The icons of the tab while it is not selected.
  ...
  return {
    ...
    compile: function(element, attr) {
      ...
      var tabNavTemplate = '<ion-tab-nav' +
        ...
        attrStr('icons-on', attr.iconOn) +
        attrStr('icons-off', attr.iconOff) +
...
.directive('ionTabNav', [function() {
  return {
    ...
    '<a ng-class="{\'tab-item-active\': isTabActive(), \'has-badge\':badge, \'tab-hidden\':isHidden()}" ' +
      ...
      '<i class="icons {{getIconOn()}}" ng-if="getIconOn() && isTabActive()"></i>' +
      '<i class="icons {{getIconOff()}}" ng-if="getIconOff() && !isTabActive()"></i>' +
 ...
 * @usage
 * ```html
 * <ion-tabs class="tabs-positive tabs-icons-only">
 *
 *   <ion-tab title="Home" icons-on="ion-ios-filing" icons-off="ion-ios-filing-outline">
 *     <!-- Tab 1 content -->
 *   </ion-tab>
 *
 *   <ion-tab title="About" icons-on="ion-ios-clock" icons-off="ion-ios-clock-outline">
 *     <!-- Tab 2 content -->
 *   </ion-tab>
 *
 *   <ion-tab title="Settings" icons-on="ion-ios-gear" icons-off="ion-ios-gear-outline">
 *     <!-- Tab 3 content -->
 *   </ion-tab>
 *
 * </ion-tabs>
